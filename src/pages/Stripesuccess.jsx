    ...
    <div className="container mx-auto mt-10 px-4">
      ...
      {accountInfo && (
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <p className="text-xl font-semibold mb-2">Your updated account information:</p>
      ...
      <p className="text-lg mb-4">Your account has been updated with the purchased token hours.</p>
