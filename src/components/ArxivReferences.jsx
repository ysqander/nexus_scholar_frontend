...
function ArxivReferences({
  ...
  return (
    <div className="mb-6">
      ...
      {showArxivRefs && (
        <>
          <p className="text-sm retro-text-light font-semibold mb-2">
                ...
                return (
                  <React.Fragment key={index}>
                    <li className="flex items-center">
                      ...
                      <span
                        className={
                          selectedReferences[ref.arxiv_id]
                            ? 'retro-text-light text-black'
                            : 'retro-text-light text-gray-400'
                        }
                      >
                        {ref.text}
                      </span>
