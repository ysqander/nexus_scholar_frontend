...
I'm trying to deploy my vite react app to railway. I was advised to use a couple of file froma tempalte:
...
:{$PORT:3000} { # access logs
log {
format json # set access log format to json mode
} # health check for railway
rewrite /health /_ # serve from the 'dist' folder (Vite builds into the 'dist' folder)
root _ dist # enable gzipping responses
encode gzip # serve files from 'dist'
file_server # if path doesn't exist, redirect it to 'index.html' for client side routing
...
The lgos when. Itried:
#10 DONE 152.8s
Aug 20 16:11:31
Aug 20 16:11:31
Aug 20 16:11:31
#11 [stage-0 7/14] COPY . /app/.
Aug 20 16:11:31
Aug 20 16:11:32
#11 DONE 0.5s
Aug 20 16:11:32
Aug 20 16:11:32
Aug 20 16:11:32
#12 [stage-0 8/14] RUN --mount=type=cache,id=s/9fe0a39e-f3d3-4d2d-b015-bb2545bb690e-/root/local/share/pnpm/store/v3,target=/root/.local/share/pnpm/store/v3 pnpm i --frozen-lockfile
Aug 20 16:11:32
Aug 20 16:11:32
#12 0.645  WARN  Ignoring not compatible lockfile at /app/pnpm-lock.yaml
Aug 20 16:11:32
Aug 20 16:11:32
#12 0.649  ERR_PNPM_NO_LOCKFILE  Cannot install with "frozen-lockfile" because pnpm-lock.yaml is absent
Aug 20 16:11:32
#12 0.649
Aug 20 16:11:32
#12 0.649 Note that in CI environments this setting is true by default. If you still need to run install in such cases, use "pnpm install --no-frozen-lockfile"
Aug 20 16:11:32
Aug 20 16:11:33
...
> [stage-0 8/14] RUN --mount=type=cache,id=s/9fe0a39e-f3d3-4d2d-b015-bb2545bb690e-/root/local/share/pnpm/store/v3,target=/root/.local/share/pnpm/store/v3 pnpm i --frozen-lockfile:
> Aug 20 16:11:33
> 0.645  WARN  Ignoring not compatible lockfile at /app/pnpm-lock.yaml
> Aug 20 16:11:33
> 0.649  ERR_PNPM_NO_LOCKFILE  Cannot install with "frozen-lockfile" because pnpm-lock.yaml is absent
> Aug 20 16:11:33
> 0.649
> Aug 20 16:11:33
> 0.649 Note that in CI environments this setting is true by default. If you still need to run install in such cases, use "pnpm install --no-frozen-lockfile"
...
- SecretsUsedInArgOrEnv: Do not use ARG or ENV instructions for sensitive data (ARG "VITE_STRIPE_PUBLIC_KEY") (line 13)
  Aug 20 16:11:33
  SecretsUsedInArgOrEnv: Do not use ARG or ENV instructions for sensitive data (ENV "VITE_STRIPE_PUBLIC_KEY") (line 14)
  Aug 20 16:11:33
...
24 | COPY . /app/.
Aug 20 16:11:33
25 | >>> RUN --mount=type=cache,id=s/9fe0a39e-f3d3-4d2d-b015-bb2545bb690e-/root/local/share/pnpm/store/v3,target=/root/.local/share/pnpm/store/v3 pnpm i --frozen-lockfile
Aug 20 16:11:33
26 |
Aug 20 16:11:33
27 | # build phase
